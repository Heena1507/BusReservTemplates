...
<body>
 ...
 <tr>
         <td><b>${list.passengerName}</b></td> 
         <td><b>${list.passengerEmail}</b></td>
  <td><b>${list.phoneNumber}</b></td>
  <td><b>${list.busName}</b></td>
  <td>${list.source}</td>
  <td><b>${list.destination}</b></td>
   <td><b>${list.seat}</b></td>
 <td><b>${list.journeyDate}</b></td>
